...
type storageConfig struct {
	Enabled                  bool              `json:"enabled"`
	ActivityRecordingEnabled bool              `json:"activity_recording_enabled"`
...
func (cfg ActiveConfig) EffectiveMode() Mode {
	if cfg.ActivityRecordingEnabled && (!cfg.RiskControlEnabled || !cfg.Enabled) {
		return ModeAsync
	}
...
func PublicFromStorage(cfg storageConfig, riskControlEnabled bool, invalidTokenEndpointIDs []string) PublicConfig {
	...
	active := ActiveConfig{RiskControlEnabled: riskControlEnabled, Enabled: cfg.Enabled, ActivityRecordingEnabled: cfg.ActivityRecordingEnabled, BlockingEnabled: cfg.BlockingEnabled}
	return PublicConfig{
		Enabled: cfg.Enabled, ActivityRecordingEnabled: cfg.ActivityRecordingEnabled, BlockingEnabled: cfg.BlockingEnabled, BlockingLatestTurnOnly: cfg.BlockingLatestTurnOnly, StorePassEvents: cfg.StorePassEvents,
...
func ActiveFromStorage(cfg storageConfig, riskControlEnabled bool, encryptor SecretEncryptor) (ActiveConfig, error) {
	active := ActiveConfig{
		RiskControlEnabled: riskControlEnabled, Enabled: cfg.Enabled, ActivityRecordingEnabled: cfg.ActivityRecordingEnabled, BlockingEnabled: cfg.BlockingEnabled,
...
func changeSummary(cfg storageConfig) string {
	...
	}{cfg.Enabled, cfg.ActivityRecordingEnabled, cfg.BlockingEnabled, cfg.BlockingLatestTurnOnly, cfg.StorePassEvents, len(cfg.Endpoints), len(cfg.Scanners), cfg.AllGroups, len(cfg.GroupIDs), ""}
