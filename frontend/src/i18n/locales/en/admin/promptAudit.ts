export default {
  promptAudit: {
    ...
    tabs: { config: 'Configuration', events: 'Events', activity: 'User activity' },
    ...
    saveBar: { enabled: 'Enable prompt audit', activityRecording: 'Record user input (non-blocking)', blocking: 'Synchronous blocking', blockingLatestTurnOnly: 'Only latest input and prior output', storePass: 'Store safe events', dirty: 'Unsaved changes', synced: 'Configuration synced' },
    blockingConfirm: {
    ...
    activity: {
      title: 'User activity',
      description: 'Summarizes only the latest user input in each request. System prompts and conversation context are not retained, and this data never participates in blocking, scheduling, or billing.',
      incompleteNotice: 'Safe-event storage is off, so this view only includes user inputs that triggered a risk finding and cannot represent complete member activity.',
      totalUsers: 'Active members', totalPrompts: 'User input records', activeDays: 'Team active days',
      keyword: 'Member or user input', keywordHint: 'Username, email, or input preview', member: 'Member', promptCount: 'Inputs',
      memberActiveDays: 'Active days', lastActive: 'Last active', modelsAndGroups: 'Models / groups', latestPrompt: 'Latest user input',
      viewRecords: 'View inputs', exportCsv: 'Export CSV by time', empty: 'No user input records in the selected range.',
      pageSummary: 'Page {page} / {pages} · {total} members',
    },
    events: {
    ...
    errors: {
      loadConfig: 'Unable to load Prompt Audit configuration.', loadRuntime: 'Unable to load Prompt Audit runtime.', loadGroups: 'Unable to load groups.', loadEvents: 'Unable to load audit events.', loadActivity: 'Unable to load user activity.', exportActivity: 'Unable to export user input records.', loadDetail: 'Unable to load event details.', saveConfig: 'Unable to save the configuration.', probe: 'Node probe failed.', delete: 'Unable to delete events.', previewDelete: 'Unable to create a deletion preview. Check the time range.', deleteConfirmation: 'The deletion confirmation is invalid or expired. Preview again.',
